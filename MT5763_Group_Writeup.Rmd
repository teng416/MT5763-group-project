...
---
The aim of this project was to produce a quick, efficient function in R capable of producing linear regression coefficients for a data set using bootstrapping. In lieu of using slow loops and inbuilt functions, we instead vectorise the code.
