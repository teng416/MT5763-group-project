...
and so on. We shall now discuss the maths behind how our function operates. We construct the matrix X which includes the intercept and covariates:
...
ggplot(data = data.f) + geom_point(mapping = aes(x, y)) + geom_abline(mapping = NULL, data = NULL, slope = slope, intercept = intercept, size = 2 ) +
...
```
This is dramatically slower than our improved functions! We have clearly made significant improvement.
